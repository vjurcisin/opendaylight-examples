 ...
 */
package itx.opendaylight.examples.cluster.demo.cli.commands;
...
public class ClusterdemoCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ClusterdemoCliTestCommand.class);
    protected final ClusterdemoCliCommands service;

    public ClusterdemoCliTestCommand(final ClusterdemoCliCommands service) {
