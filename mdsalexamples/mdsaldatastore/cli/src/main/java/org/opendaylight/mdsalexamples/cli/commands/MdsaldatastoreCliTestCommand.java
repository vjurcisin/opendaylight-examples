 ...
 */
package org.opendaylight.mdsalexamples.cli.commands;
...
public class MdsaldatastoreCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(MdsaldatastoreCliTestCommand.class);
    protected final MdsaldatastoreCliCommands service;

    public MdsaldatastoreCliTestCommand(final MdsaldatastoreCliCommands service) {
